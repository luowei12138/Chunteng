...
<HTML>
<HEAD><TITLE>404错误页面</TITLE><!--STATUS OK-->
    ...
    <![endif]-->
    <!--[if (lt IE 8.0)]>
    <LINK href="${pageContext.request.contextPath }/statics/files/qbase.css" type=text/css
          rel=stylesheet><![endif]--><!--[if (!IE)|(gte IE 8.0)]><!-->
    <link href="${pageContext.request.contextPath }/statics/files/qbase_datauri.css" type=text/css rel=stylesheet><!--<![endif]-->
    ...
    <DIV class="mod-page-main wordwrap clearfix">
        <DIV class=x-page-container>
            <DIV class="mod-notfound grid-98"><IMG class=img-notfound height=320
                                                   src="${pageContext.request.contextPath }/statics/files/notfound.gif" width=520>
