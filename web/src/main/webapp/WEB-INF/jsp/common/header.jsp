...
<body class="nav-md footer_fixed">
    <div id="div_userId" class="form-group" style="display: none;">${userSession.userType}</div>
	<div class="container body">
		<div class="main_container">
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/api/users/index" class="site_title"><i class="fa fa-paw"></i> <span>春藤医院管理系统</span>
						</a>
					</div>
					...
					<div class="profile">
						<div class="profile_pic">
							<img
								src="${pageContext.request.contextPath }/api/users/showImg?userId=${userSession.id }"
								alt="..." class="img-circle profile_img">
						</div>
						<div class="profile_info">
							<span>Welcome,</span>
							<h2>${userSession.account }</h2>
						</div>
					</div>
					<!-- /menu profile quick info -->
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul id="menus_ul" class="nav side-menu">
								<%--
								<li><a><i class="fa fa-home"></i> 菜单管理 <span class="fa fa-chevron-down"></span></a>
								...
								<li><a><i class="fa fa-edit"></i> 用户管理<span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/api/users/list">用户列表</a></li>
									</ul>
                                </li>
								--%>
							</ul>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings">
							...
							href="${pageContext.request.contextPath }/api/auth/logout"> <span
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								aria-expanded="false"> <img
									src="${pageContext.request.contextPath }/api/users/showImg?userId=${userSession.id }"
									alt="">${userSession.account } <span
									class=" fa fa-angle-down"></span> </a>
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a
										href="${pageContext.request.contextPath }/api/logout"><i
